...
### Self Check
- Did you use all three methods of adding CSS to an HTML file? ok
- Did you properly link the external CSS file in the HTML file? ok
- Does the `div` element have CSS added via the external method? ok
- Does the `p` element have CSS added via the internal method? ok
- Does the `button` element have CSS added via the inline method? ok
